...
worked on a wireless canine chew sensor for research trials.`
    ...
    desc: `Served as a teaching assistant for an upper-level course in embedded
systems and prototyping intelligent devices. Supported lectures and labs on
microcontroller programming, circuit design, and rapid prototyping. 
Co-developed lab guides, assignments, and project docs, and mentored teams on
hardware/software integration, debugging, and design trade-offs.`
  },
  {
...
hours.`
  },
  {
    ...
    desc: `Led a team of nine student assistants providing campus IT support.
Delivered multi-channel support (in-person, phone, remote), managed incidents,
and supported inventory and documentation. Contributed to IT implementations
and program improvements.`
  },
  {
    ...
    desc: `Provided CAD design services using Fusion 360 and AutoCAD for
machined parts. Delivered projects for domestic and international clients,
coordinating with overseas manufacturers specializing in CNC and 3D printing.`
  }
];
