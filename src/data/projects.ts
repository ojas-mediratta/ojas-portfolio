...
export const PROJECTS: Project[] = [
  ...
  //     { type: 'image', src: 'media/tactile-sensing/g1_with_sensors.png', caption: 'Unitree G1 with chest, forearm, and palm tactile sensors mounted.' },
  ...
  //       type: 'carousel',
  //       items: [
  //         { src: 'media/tactile-sensing/sensor_kicad.png', caption: 'Sensor routing and layout in KiCad.' },
  //         { src: 'media/tactile-sensing/stackup_3d_viewer2.png', caption: 'Stackup render from the KiCad model.' },
  //         { src: 'media/tactile-sensing/sensor_real1.png', caption: 'Fabricated tactile array after assembly.' },
  //         { src: 'media/tactile-sensing/sensor_real2.png', caption: 'Assembled array ready for data collection.' },
  //         { src: 'media/tactile-sensing/chest_mount_print.png', caption: 'Chest mount print-in-place test on the bed.' },
  //         { src: 'media/tactile-sensing/chest_mount.png', caption: 'Chest mount CAD model.' },
  //       ],
  //     },
