...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    { type: 'text', content: `We then moved to the 'Walk' project, which focuses on legged locomotion and control for Boston Dynamics' Spot quadruped, including forward and inverse kinematics and probabilistic roadmaps.` },
